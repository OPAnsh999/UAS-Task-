...
img_path = "D:\\Ansh Tayal\\DTU ECE\\Societies\\UAS\\UAS Task\\1.png"
img = cv2.imread(img_path)   # <-- now img is a NumPy array (image data)
...
cv2.imwrite("blue_mask.jpg",land_mask)
